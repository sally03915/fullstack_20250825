   ...
   <div class="container card  my-5 p-4">
	  ...
	  <div> 
		  ...
		  <c:if   test="${not empty email}">
			  ...
			  <div class="mb-3">
			  	<a href="${pageContext.request.contextPath}/deleteView.do?id=${dto.id}" class="btn btn-secondary form-control">글삭제</a>
			  </div>
		  </c:if>
		  
		  
		  <div class="mb-3">
		  	<a href="${pageContext.request.contextPath}/list.do" class="btn btn-primary form-control">목록보기</a>
		  </div>
	 </div>
   </div> 
