...
public class Arr001 {
	public static void main(String[] args) {
		...
		// 1) int [] arr  주소를 보관할준비됐어요~!  2) null   공간은 있지만 값이 없어요!
		int [] arr = null  ;
		System.out.println(arr);
 		
		//[stack] arr2 주소보관 = [heap] 1,2,3 연속된공간에 저장 
		int         [] arr2   = {1,2,3}; 
		...
		//3. 배열예시(4)  : arr6 'a' , 'b' , 'c'
		char[] arr6 = {'a' , 'b' , 'c'};  //0~2
		System.out.println(arr6[0]); System.out.println(arr6[1]); System.out.println(arr6[2]);
