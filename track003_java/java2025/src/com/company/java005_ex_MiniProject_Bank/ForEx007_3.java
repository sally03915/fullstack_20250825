...
public class ForEx007_3 {
	public static void main(String[] args) {
		//변수
		String std="";  
		int    kor = -1, eng = -1, mat=-1, total;  /* 0.  0~100사이가아닌 값*/
		double avg;
		...
		for(;;) { //1. 무한반복
			if( !(0<=kor &&  kor <=100)) { //2-1.점검 : 0~100사이가 아니라면
				System.out.print("국어점수 입력 > ");  kor = scanner.nextInt(); //2-2. 입력받고
			}else if( !(0<=mat &&  mat <=100) ) { //3-1.점검 : 0~100사이가 아니라면
				System.out.print("수학점수 입력 > ");  mat = scanner.nextInt(); //3-2. 입력받고
