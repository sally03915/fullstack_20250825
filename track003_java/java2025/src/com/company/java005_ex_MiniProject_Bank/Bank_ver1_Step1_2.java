...
public class Bank_ver1_Step1_2 {
	public static void main(String[] args) {
		...
		for(;;) {
			...
			else if(num == 1 ) {  System.out.println("1.추가기능입니다.");        } 
			else if(num == 2 ) {  System.out.println("2.조회기능입니다.");        } 
			else if(num == 3 ) {  System.out.println("3.입금입니다.");           } 
			else if(num == 4 ) {  System.out.println("4.출금입니다.");           } 
			else if(num == 5 ) {  System.out.println("5.삭제입니다.");           } 
