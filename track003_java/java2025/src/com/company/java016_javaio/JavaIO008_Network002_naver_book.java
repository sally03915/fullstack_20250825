...
public class JavaIO008_Network002_naver_book {
	public static void main(String[] args) {
		try {
			...
			conn.setRequestProperty("X-Naver-Client-Id", "AqGs1swmWieSswFk8doU");
			conn.setRequestProperty("X-Naver-Client-Secret", "4B8igOnoSi");
