...
public class Casting002_char {
	public static void main(String[] args) {
		//#1. 문자 초기화
		// 문자는 저장시 숫자 / 출력시 문자
		char ch1 = ' ';   //공백한개라도 있어야 오류가 안남.   'a' 'A' 
		char ch2 = '\u0000';
		...
		System.out.println("step4 : " + (c+1));  // 다음의 결과물은?  66
		//2-1)  'A'+1
		...
		String str1 = "abc";   //"abc" "abcd" "abcde"
		String str2 = "abc";
		String str3 = new String("abc");
		
		System.out.println(  System.identityHashCode(str1)  );  //1876631416
		System.out.println(  System.identityHashCode(str2)  );  //1876631416
		System.out.println(  System.identityHashCode(str3)  );  //1359044626
