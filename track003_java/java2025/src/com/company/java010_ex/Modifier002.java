...
class UserSon2 extends UserInfo{
	...
	}  //■Q1.  super.house를 못쓰는 이유는 - UserInfo 클래스의 house는 접근자가 package (java010 폴더안에서만)
...
public class Modifier002 {
	public static void main(String[] args) {
		...
		// user.house = "전라남도장성군";   ■ Q3. 오류이유? 같은폴더아님 - java010_ex 폴더안에 있음.
		// user.iO    = 148;        // iO cannot be resolved or is not a field
		 user.setiQ(148);
