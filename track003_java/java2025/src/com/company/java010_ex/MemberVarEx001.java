...
class Sawon3{ 
  ...
  //static int basicpay=pay; // 클래스변수   - method area - new X - 생성자 X  > 바로사용 클래스명.basicpay
    						 // ※ static은 this사용 불가  / 당장사용해야하는데 this를 쓰려면 new 하고 난다음에
...
[heap: 동적]                 | [stack : 잠깐빌리기]
							  showAll001();
1번지{pay=0, showAll001() }  ← sola[1번지]   32번째줄 
					        | main 
------------------------------------------------------------------------------------------
*/
