...
public class Poly003 {
	public static void main(String[] args) {
		...
		//					                           = 1번지{int a , toString}
		/*-------------------------------------------------------------
		method[공통: static, final, abstract]     TestA3 , TestB3 , Poly003
		-------------------------------------------------------------	
		heap[동적]						| stack[지역]	
		1번지 TestA3{int a , toString}  ←   tb[1번지]	 
	 									   tb[null]  TestB3{int b , @toString} - TestA3{int a , -----}
										| main
		-------------------------------------------------------------*/
		...
		/*
		 Exception in thread "main" java.lang.ClassCastException: 
		      class com.company.java012.TestA3 cannot be cast to class com.company.java012.
		       TestB3 (com.company.java012.TestA3 and com.company.java012.TestB3 
		          are in unnamed module of loader 'app') at com.company.java012.Poly003.main(Poly003.java:22)
