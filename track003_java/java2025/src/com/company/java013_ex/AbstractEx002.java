...
abstract class Astronaut {
    protected String name;  // 인스턴스변수 - hepa area - this각각
...
public class AbstractEx002 {
	public static void main(String[] args) {
        ...
        // crew[1] = Biologist{explore(), report(), rest()} - { name="Flora", stamina=60 /--,--,-- }
        // crew[2] = Pilot{explore(), report(), rest()}     - { name="Jet"  , stamina=85 /--,--,-- }
        Astronaut[] crew = { new Engineer(), new Biologist(), new Pilot() };
        String[] names = { "Nova", "Flora", "Jet" };
        int[] stamina = { 75, 60, 85 };

        // Q2. 체력이 낮은 대원만 휴식  70미만이 휴식을 취하게 만들기   / 충분한 체력을 유지 중입니다.
