...
class  ChocoCookie     implements Cookie{@Override public void make(){ System.out.println("초코쿠기");}}
class  DeepChocoCookie implements Cookie{@Override public void make(){ System.out.println("딥초코쿠기");}}
class  BananaCookie    implements Cookie{@Override public void make(){ System.out.println("바나나쿠기");}}
//3.   L: 리스코프 치환 ( 어떤쿠키든 Cookie 인터페이스로 바꿔써도 문제 없어요!  부모 = 자식  )
class CookieFactory{// Cookie cookie = 각종 쿠키종류
	public void makeCookie(Cookie cookie) { cookie.make(); }// 어떤쿠키든 여기서 만들수 있어요~!
}
//4.   I : interface - 너무 많은 기능을 강요하지 말것! 꼭필요한 기능만 (절차)
...
//5. 의존역전원칙 - CookieFacotry는 구체적인 쿠키가아니라 추상적인 Cookie에 의존
class CookieShop{
...
public class SolidBasic {
	public static void main(String[] args) {
		...
		//2+3.  O, L
		System.out.println("2+3.	OL: 개방폐쇄 (레시피는추가) + 리스코프(공장-어떤쿠키든굽기가능) 치환");
		...
		//4.    I 인터페이스분리
		System.out.println("4.	 I 인터페이스분리");
